...
public class LoginFashion extends AppCompatActivity {
    private ViewGroup rootLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_login_fashion);
    ...
    public void showSingUp(View view) {
        ...
        a.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation arg0) {
                ...
                rootLayout.setBackgroundColor(ContextCompat.getColor(LoginFashion.this, R.color.colorPrimary));
                ((View) animationSquare.getParent()).setBackgroundColor(ContextCompat.getColor(LoginFashion.this, R.color.colorPrimary));
    ...
    public void showLogIn(View view) {
        ...
        a.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation arg0) {
                ...
                rootLayout.setBackgroundColor(ContextCompat.getColor(LoginFashion.this, R.color.colorAccent));
                ((View) animationSquare.getParent()).setBackgroundColor(ContextCompat.getColor(LoginFashion.this, R.color.colorAccent));
