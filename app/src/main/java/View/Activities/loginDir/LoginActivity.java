package com.asi.educatyapp.loginDir;
...
import View.Activities.Admin_Activity;
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST,
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        {
                            Toast.makeText(LoginActivity.this,"New Acount Added",Toast.LENGTH_LONG).show();
                        }
                        else
                        {
                            //  Constant.showAlertDialog("Oops!",message,R.drawable.info,Login.this);
                            Toast.makeText(LoginActivity.this,"There are an error try again later",Toast.LENGTH_LONG).show();
                        }
...
//                String id = user.get("uid");
    ...
    public void logIn()
    {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Constants.BASEURL+"AdminLogin.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                //here is the response of server
...
//                        Toast.makeText(LoginActivity.this,"User Exist",Toast.LENGTH_LONG).show();
//                        db.addUser(name,email,id,"0");
//                        session.setLogin(true);
                        if(type.equals("Admin"))
                        {
                            startActivity(new Intent(LoginActivity.this,Admin_Activity.class));
                            db.addUser(name,email,id,"","Admin","");
                            session.setLoginAdmin(true);
                            finish();
                        }
    ...
    public void logInTeacher()
    {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Constants.BASEURL+"TeacherLogin.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                //here is the response of server
