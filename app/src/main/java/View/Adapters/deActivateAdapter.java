...
import Data.Data.Models.TeacherModel;


/**
 * Created by Abdulrhman on 22/02/2017.
 */
public class deActivateAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {

    ArrayList<TeacherModel> arrayList;
    Context context;
    RecyclerView adapterRecycler;

    public deActivateAdapter(Context context, ArrayList<TeacherModel> arrayList, RecyclerView recyclerView) {
        this.arrayList = arrayList;
        this.context = context;

        adapterRecycler=recyclerView;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.deactivation, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof GenericViewHolder) {
            ...
            genericViewHolder.deactivate.setOnClickListener(new View.OnClickListener() {
                @Override
                    ...
                    final StringRequest strReq = new StringRequest(Request.Method.POST,
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (status.equals("1"))
                                {
                                    Toast.makeText(context,"Teacher deActicated",Toast.LENGTH_LONG).show();
    ...
    class GenericViewHolder extends RecyclerView.ViewHolder  {
        ...
        public GenericViewHolder (View itemView) {
            super (itemView);
            name=(TextView)itemView.findViewById(R.id.name_text_view_deactivate);
            title= (TextView) itemView.findViewById(R.id.title_text_view_deactivate);
            picture= (ImageView) itemView.findViewById(R.id.imageadectivation);
            deactivate = (Button) itemView.findViewById(R.id.deactivateButton);
        }
